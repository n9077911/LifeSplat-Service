...
//
//             var amount = calc.Calculate(new Person {Dob = new DateTime(1981, 5, 30)}, 10_000, new DateTime(2050, 1, 1), 1).Amount;
//             Assert.That(amount, Is.EqualTo(9110.4m));
//             
//             amount = calc.Calculate(new Person {Dob = new DateTime(1981, 5, 30)}, 10_000, new DateTime(2020, 5, 30), 1).Amount;
//             Assert.That(amount, Is.EqualTo(4685.35m));
//             
//             //minimum 10 contributing years required
//             amount = calc.Calculate(new Person {Dob = new DateTime(1981, 5, 30)}, 10_000, new DateTime(2011, 5, 30), 1).Amount;
...
//             var calc = new StatePensionAmountCalculator(_fixedDateProvider, new TwentyTwentyTaxSystem());
//
//             var amount = calc.Calculate(new Person {NiContributingYears = 10}, 10_000, new DateTime(2050, 1, 1), 1).Amount;
//             Assert.That(amount, Is.EqualTo(9110.4m));
//             
//             amount = calc.Calculate(new Person {NiContributingYears = 8}, 10_000, new DateTime(2030, 5, 30), 1).Amount;
//             Assert.That(amount, Is.EqualTo(4685.35m));
//             
//             //minimum 10 contributing years required
//             amount = calc.Calculate(new Person {NiContributingYears = 9}, 10_000, new DateTime(2011, 5, 30), 1).Amount;
//             Assert.That(amount, Is.EqualTo(0m));
//         }
//         
//         [Test]
...
//              var amount = calc.Calculate(new Person {NiContributingYears = 10}, 5_000, new DateTime(2050, 1, 1), 1).Amount;
//              Assert.That(amount, Is.EqualTo(2602.97));
//             
//              //years given have no impact as < 10 - salary has no impact - children have no impact
//              amount = calc.Calculate(new Person {NiContributingYears = 9}, 5_000, new DateTime(2050, 1, 1), 1).Amount;
//              Assert.That(amount, Is.EqualTo(0));
//             
//              //no years given - salary has no impact - children have no impact
//              amount = calc.Calculate(new Person {Dob = new DateTime(1981, 5, 30)}, 5_000, new DateTime(2050, 1, 1), 1).Amount;
//              Assert.That(amount, Is.EqualTo(0));
//             
//              //no years given - salary has no impact - child has impact
//              var result = calc.Calculate(new Person {Dob = new DateTime(1981, 5, 30), Children = {new DateTime(2015, 1, 1)}}, 5_000, new DateTime(2050, 1, 1), 1);
...
//             result = calc.Calculate(new Person {NiContributingYears = 9, Children = {new DateTime(2015, 1, 1), new DateTime(2020, 1, 1)}}, 5_000,
//                 new DateTime(2050, 1, 1), 1);
