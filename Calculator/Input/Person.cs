...
namespace Calculator.Input
{
    public class Person
    {
        public Money ExistingSavings { get; set; }
        public Money ExistingPrivatePension { get; set; }
        ...
        public PensionContribution EmployeeContribution { get; set; }
        public PensionContribution EmployerContribution { get; set; }
    }
